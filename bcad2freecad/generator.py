...
class FreeCADScriptGenerator:
    ...
    def generate(self) -> str:
        ...
        # Dropout sketches are a separate, deferred feature; in sketch mode we
        # emit only the tube-axis skeleton and skip the (solid) dropouts.
        if not self.sketch:
...
tube-axis wireframe: one Draft line per tube centerline, labelled <tube>_axis.
"""
